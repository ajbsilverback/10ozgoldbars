...
interface MetalSpotIndexCardProps {
...
export default function MetalSpotIndexCard({ data, error }: MetalSpotIndexCardProps) {
  if (error) {
    return (
      <div className="bg-white border border-red-200 rounded-xl p-6 shadow-sm">
        <p className="text-red-600 text-sm">Unable to load spot data</p>
      </div>
    )
  }
